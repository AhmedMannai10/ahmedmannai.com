...
const ContentSecurityPolicy = `
  ...
  connect-src *;
  font-src 'self';
  frame-src giscus.app youtube-nocookie.com
`
...
module.exports = () => {
  ...
  return plugins.reduce((acc, next) => next(acc), {
    ...
    async redirects() {
      return [
        // Route move: /projects -> /apps. The old detail slugs were derived
        // from the full title, so they are mapped explicitly.
        { source: '/projects', destination: '/apps', permanent: true },
        {
          source: '/projects/sportzme---find-sport-play-now',
          destination: '/apps/sportzme',
          permanent: true,
        },
        {
          source: '/projects/tantap---business-relationship-management',
          destination: '/apps/tantap',
          permanent: true,
        },
        { source: '/projects/:slug', destination: '/apps/:slug', permanent: true },
        // The consulting booking page is gone.
